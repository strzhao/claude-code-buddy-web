  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" className="w-12 h-12" fill="none">
        <rect x="4" y="8" width="40" height="32" rx="4" className="stroke-primary" strokeWidth="3" />
        <text x="24" y="28" textAnchor="middle" className="fill-primary" fontSize="11" fontFamily="monospace" fontWeight="bold">0.3M</text>
        <circle cx="12" cy="16" r="3" className="fill-primary" opacity="0.5" />
      </svg>
    ),
    title: "Token 监控",
    description:
      "菜单栏实时查看每个会话的模型、时长、Token 消耗和工具调用次数。再也不怕预算超标",
  },
  {
    icon: (
      <Image
  ...
  return (
    <section id="features" className="py-16 px-6">
      <div className="max-w-5xl mx-auto">
        <h2 className="pixel-heading text-3xl text-ink mb-3 text-center">
          为什么选择 Buddy
        </h2>
